  ...
  return (
    <div className="bg-gray-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-xl text-[#EE66A6] mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-10">
          <div className="text-left flex items-start gap-4">
            <FaBullhorn className="text-4xl text-[#D91656]" />
            <div>
              <h3 className="text-2xl font-semibold text-[#D91656] mb-4">
                Our Mission
              </h3>
          ...
          <div className="text-left flex items-start gap-4">
            <FaTruck className="text-4xl text-[#D91656]" />
            <div>
              <h3 className="text-2xl font-semibold text-[#D91656] mb-4">
                Why Choose Us
              </h3>
        ...
        <div className="flex justify-center mb-10 gap-4">
          <div className="text-center">
            <FaHeadset className="text-4xl text-[#D91656] mb-4" />
            <h3 className="text-2xl font-semibold text-[#D91656] mb-2">Customer Support</h3>
            <p className="text-lg text-gray-700">
        ...
        <div className="text-center">
          <a
            href="/contact"
            className="bg-[#D91656] text-white px-6 py-3 rounded-full hover:bg-[#EE66A6] transition duration-300 ease-in-out"
          >
            Contact Us
          </a>
        </div>
