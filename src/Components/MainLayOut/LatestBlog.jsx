  ...
  return (
    <div className="w-11/12 mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* 1 */}
        <JackInTheBox>
          <div className="lg:card-side bg-[#f8f8f8] shadow-xl dark:bg-gray-800">
            <figure>
              <img
        ...
        <JackInTheBox>
          <div className="lg:card-side bg-[#f8f8f8] shadow-xl dark:bg-gray-800">
            ...
            <div className="card-body">
              ...
              <p className="dark:text-gray-300">
                Explore how advancements in technology and design have
                revolutionized modern sports equipment for athletes worldwide...{" "}
                <span className="text-rose-400">read more</span>
              </p>
            </div>
          </div>
        ...
        <JackInTheBox>
          <div className="lg:card-side bg-[#f8f8f8] shadow-xl dark:bg-gray-800">
            ...
            <div className="card-body">
              ...
              <p className="dark:text-gray-300">
                Learn about balanced diet plans tailored to fuel your body and
                optimize performance for an active lifestyle...{" "}
                <span className="text-rose-400">read more</span>
              </p>
            </div>
          </div>
